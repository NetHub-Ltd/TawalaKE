...
#     # status: SaleStatus = Field(default=SaleStatus.PENDING_PAYMENT)
#     # Inside class Sale(BaseMixin, table=True):
...
#     # CRITICAL SHORTCUT: Pulls SaleItems directly via their shared sale_id relation
#     items: List[SaleItem] = Relationship(
#         sa_relationship_kwargs={
#             "primaryjoin": "FinancialDocument.sale_id == SaleItem.sale_id",
#             "lazy": "joined",
#             "viewonly": True
#         }
#     )
