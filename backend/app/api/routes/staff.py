"""Organization staff management (org:staff:manage).

Dedicated router. Sole HTTP mount: /api/v1/staff
Staff identity and administration are organization-scoped;
business access is assignment scope only (PUT /{id}/businesses).
"""
