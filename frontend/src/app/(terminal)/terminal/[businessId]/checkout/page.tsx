...
//   const { cart, getFinancials, getReceiptPayload, clearCart } = useCartStore();
...
//     setTimeout(() => {
//       // Simulate successful STK Push log synchronization
//       const payload = getReceiptPayload("BIZ-PRO-01", "CASHIER-MAIN", "MPESA");
...
//     setIsProcessing(true);
//     setTimeout(() => {
//       const payload = getReceiptPayload("BIZ-PRO-01", "CASHIER-MAIN", "CASH");
...
//     setIsProcessing(true);
//     setTimeout(() => {
//       const payload = getReceiptPayload("BIZ-PRO-01", "CASHIER-MAIN", "INVOICE");
...
//     setTimeout(() => {
//       // Simulate successful STK Push log synchronization
//       const payload = getReceiptPayload(businessId || "BIZ-PRO-01", "CASHIER-MAIN", "MPESA");
//       console.log("Mpesa STK Checkout Payload Persisted Safely:", payload);
...
//     setTimeout(() => {
//       const payload = getReceiptPayload(businessId || "BIZ-PRO-01", "CASHIER-MAIN", "CASH");
//       console.log("Cash Checkout Payload Persisted Safely:", payload);
...
//     setTimeout(() => {
//       const payload = getReceiptPayload(businessId || "BIZ-PRO-01", "CASHIER-MAIN", "INVOICE");
//       console.log("Draft Invoice Generation State Logged:", payload);
...
//   const handleCompleteOrderLifecycle = () => {
//     // Navigate directly to document generation layout, passing method selection as safe url params
//     router.push(`/terminal/${businessId}/checkout/receipt?method=${selectedMethodParam}`);
//   };
