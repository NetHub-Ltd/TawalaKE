...
export default function OverviewPage() {
  ...
  // Secondary row — rest of the payload, plain language
  ...
  return (
    <div className="w-full h-full flex flex-col min-h-0 gap-5 p-4 overflow-y-auto no-scrollbar text-foreground">
      ...
      {/* 3 main numbers */}
      {/* 3 main numbers — always horizontal */}
<section className="grid grid-cols-3 gap-2 sm:gap-3 shrink-0">
  {primaryMetrics.map((m) => {
    ...
    return (
      ...
      {/* Quiet detail strip — remaining payload fields */}
      ...
      {/* Chart */}
      <section className="flex-1 min-h-[220px] bg-card border border-border/40 rounded-2xl p-5 flex flex-col">
        <div className="mb-2">
