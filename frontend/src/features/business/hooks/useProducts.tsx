...
export function useProducts(
  ...
  // Reduced client-side cache window to 1s to stay aligned with server-side Redis TTLs
  const CACHE_CONFIG = {
    staleTime: 1000, // 1 second stale window
    gcTime: 5 * 1000, // 5 seconds garbage collection
  };
