...
//   // 300ms Debounce Handler for true database search execution
//   useEffect(() => {
...
//   // Reset pagination offset on debounced query or page-size adjustments to prevent empty states
//   useEffect(() => {
//     setCurrentPage(1);
//   }, [debouncedSearch, itemsPerPage]);

//   // Wired server-paginated & server-searched useProducts hook
...
//           {/* Integrated Header Controls (Search & Page Size) */}
...
//                 Search database items by product name or SKU
//               </label>
...
// Parent File Import: features/inventory/InventoryRegistry.tsx
// File Path: src/features/business/components/InventoryRegistry.tsx
...
//   // TypeScript narrowing fix: Extract execution block into a direct scope check
...
// Parent File Import: src/features/inventory/components/InventoryRegistry.tsx (or parent route wrapper)
// File Path: src/features/inventory/components/InventoryRegistry.tsx
