...
//       <header className="border-b border-border/80 bg-card/95 py-4 flex items-center justify-between shrink-0 z-20 backdrop-blur-xs">
...
//             {/* <Button variant="primary" size="sm">
//               <Plus size={14} strokeWidth={3} className="shrink-0" /> 
//               <span>New Poduct</span>
//             </Button> */}
             
//             <div className="flex border items-center p-4 gap-4  rounded-xl border-slate-200">
//               <Plus size={16} strokeWidth={3} className="shrink-0" />
//               <p className="pr-2">Add New Product</p>
//             </div>
//           </Link>
...
export function InventoryRegistry() {
  ...
  return (
    <main className="flex-1 flex flex-col h-full max-h-full font-sans overflow-hidden">
      
      {/* Header Panel Surface Container - Locked and Sticky */}
      <header className="border-b border-border/80 bg-card/95 py-4 px-6 flex items-center justify-between shrink-0 z-20 backdrop-blur-xs">
      ...
      {/* Main Database Layer - Fully isolated parent container bounded strictly within maximum grid dimensions */}
      <div className="flex-1 p-4 min-h-0 overflow-hidden flex flex-col">
        <div className="bg-card border border-border rounded-xl shadow-xs overflow-hidden flex flex-col flex-1 min-h-0">
          ...
          {/* Table Footer Navigation Panel - Locked and Sticky */}
          <footer className="border-t border-border bg-background/30 px-6 py-4 flex items-center justify-between shrink-0">
            <span className="text-xs font-medium text-muted tabular-nums">
              Showing{" "}
              <span className="text-foreground font-bold">
