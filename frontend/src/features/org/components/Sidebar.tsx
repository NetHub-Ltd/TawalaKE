...
//   { label: "Overview", path: "/#", allowedRoles: ["OWNER"], icon: Settings },
//   { label: "Terminal", path: "", allowedRoles: ["OWNER", "MANAGER", "CASHIER"], icon: Monitor },
//   { label: "Stock Management", path: "/inventory", allowedRoles: ["OWNER", "MANAGER"], icon: Package },
//   { label: "Sales History", path: "/#", allowedRoles: ["OWNER", "MANAGER", "CASHIER"], icon: History },
//   // { label: "Analytics", path: "/#", allowedRoles: ["OWNER"], icon: Settings },
//   { label: "Products", path: "/#", allowedRoles: ["OWNER", "MANAGER", "CASHIER"], icon: Monitor },
//   { label: "Staff", path: "/#", allowedRoles: ["OWNER", "MANAGER"], icon: Package },
//   { label: "Receipts and Invoices", path: "/#", allowedRoles: ["OWNER", "MANAGER", "CASHIER"], icon: History },
//   { label: "Store Settings", path: "/#", allowedRoles: ["OWNER"], icon: Settings },
// ];
...
const NAVIGATION_SCHEMA: SidebarLink[] = [
  ...
  { label: "Stock Management", path: "/inventory", allowedRoles: ["OWNER", "MANAGER"], icon: Package },
  { label: "Sales History", path: "/#", allowedRoles: ["OWNER", "MANAGER", "CASHIER"], icon: History },
  { label: "Products", path: "/#", allowedRoles: ["OWNER", "MANAGER", "CASHIER"], icon: Boxes },
