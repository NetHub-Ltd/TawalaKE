...
//           Sign in to continue managing your shop — sales, stock, and team in one place.
//         </p>
//       </header>
...
//                 emailOk ? 'text-emerald-500' : 'text-muted-foreground/50'
//               }`}
//               size={18}
//               aria-hidden="true"
//             />
...
//           </div>
//           {errors.email ? (
//             <p id="email-error" className="text-destructive text-xs font-medium mt-1.5 pl-1" role="alert">
//               {errors.email.message}
//             </p>
//           ) : (
//             <p id="email-hint" className="text-[11px] text-muted-foreground/70 mt-1.5 pl-1">
...
//               className="text-xs font-semibold text-primary hover:underline outline-none focus:ring-2 focus:ring-primary rounded px-1 py-0.5"
//             >
//               Forgot password?
//             </Link>
//           </div>
...
//             <Lock
//               className={`absolute left-4 top-3.5 transition-colors ${
//                 passwordOk ? 'text-emerald-500' : 'text-muted-foreground/50'
//               }`}
//               size={18}
//               aria-hidden="true"
//             />
...
//               disabled={isLoading}
//               className="absolute right-4 top-3.5 text-muted-foreground/50 hover:text-foreground transition-colors outline-none focus:ring-2 focus:ring-primary rounded p-0.5 disabled:opacity-50 min-h-[24px] min-w-[24px] flex items-center justify-center"
...
//           </div>
//           {errors.password && (
//             <p id="password-error" className="text-destructive text-xs font-medium mt-1.5 pl-1" role="alert">
...
//             className="w-full bg-primary hover:bg-primary/95 disabled:opacity-70 text-primary-foreground text-sm font-bold py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer shadow-md min-h-[48px] disabled:cursor-wait disabled:pointer-events-none active:scale-[0.99]"
//           >
//             {isLoading ? (
//               <>
//                 <Loader2 className="animate-spin" size={18} aria-hidden="true" />
//                 <span aria-live="polite">{LOADING_MESSAGES[loadingIndex]}</span>
//               </>
//             ) : (
//               <span>Sign in</span>
//             )}
...
//           {isLoading && (
//             <p className="text-center text-[11px] text-muted-foreground animate-pulse" aria-live="polite">
...
//             className="font-bold text-primary hover:underline outline-none focus:ring-2 focus:ring-primary rounded px-1 py-0.5"
//           >
//             Start free
//           </Link>
//         </p>
