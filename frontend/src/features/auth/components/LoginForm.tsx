...
function safeCallbackUrl(raw: string | null): string {
  if (!raw) return '/org';
  // Relative only — blocks open redirects
    ...
    >
      ...
      >
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/forgot-password"
              className="text-xs font-semibold text-brand-primary hover:underline outline-none focus:ring-2 focus:ring-brand-primary/40 rounded px-1 py-0.5"
            >
              Forgot password?
            </Link>
          </div>
      ...
      <footer className="text-center pt-2">
        <p className="text-sm text-muted">
          ...
          <Link
            href="/onboarding/personal-details"
            className="font-bold text-brand-primary hover:underline outline-none focus:ring-2 focus:ring-brand-primary/40 rounded px-1 py-0.5"
          >
            Start free
          </Link>
        </p>
