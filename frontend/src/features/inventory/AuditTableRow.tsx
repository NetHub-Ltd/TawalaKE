...
// // Union handles string inputs from HTML input before piping to strict number rules
...
//           message: "Physical quantity must be a valid numerical metric",
//         })
//         .min(0, "Physical stock cannot fall below zero boundaries")
//     ),
//   reason_code: z.string().default(""),
//   notes: z.string().default(""),
// });

// type AuditFormData = z.output<typeof auditFormSchema>;
